...
import (
	...
	"github.com/MariusBobitiu/surface-lab/php-stack/config"
	phpgrpc "github.com/MariusBobitiu/surface-lab/php-stack/transport/grpc"
...
func main() {
	...
	if err := cfg.Validate(); err != nil {
		slog.Error("invalid php-stack config", "error", err)
		os.Exit(1)
	}

	logger := utils.NewLogger("php-stack", cfg.Environment)
	...
	server, err := phpgrpc.NewServer(logger, phpgrpc.ServerOptions{
	...
	logger.Info(
		"php-stack gRPC server listening",
		"address", cfg.Address(),
		"env", cfg.Environment,
